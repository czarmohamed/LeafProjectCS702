...
# Read Image
leaf = cv2.imread(r"C:\Users\user-pc\Downloads\ImageData\ny1079-01-1.jpg")
...
# ------------------------------------------------------------------
# Thresholding
thresh = cv2.medianBlur(img, 3) # smooth the image
...
imgarray = []
files = glob.glob(r"C:\Users\user-pc\Downloads\ImageData\*.jpg")
for myFile in files:
...
# ------------------------------------------------------------------
# Calculate the feature values for the feature vector
featureData = []
...
dataset = pd.read_csv(r"C:\Users\user-pc\Downloads\leafdataset.txt", names=featureVector)

X = dataset.iloc[:, :-1].values
y = dataset.iloc[:, 12].values

xtrain, xtest, ytrain, ytest = train_test_split(X, y, test_size=0.04)
